...
const Post = ({addToCart,Product,buyNow}) => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="object-cover object-center  h-[50vh] block" src={Product.img}/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex">
          ...
          <button onClick={()=>{buyNow(slug,1,Product.price,Product.title,'Xl','Red')}}className="flex ml-auto text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded">Buy Now</button>
          <button onClick={()=>{addToCart(slug,1,Product.price,Product.title,'Xl','Red')}} className="flex ml-auto text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded">Add To Cart</button>
        ...
        <div className='mt-6 flex space-x-2 text-sm'>
          <input onChange={onChangepin} className='px-2 border-2 border-gray-400 text-sm' type='text' />
          <button onClick={checkpin} className="flex ml-auto text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded">Check</button>
        </div>
